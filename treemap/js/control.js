$( document ).ready(function() {
	...
	d3.csv("data/coins_sept10_dataset_3.csv", function(csv_data){
		...
		var nested_data = d3.nest()
			.key(function(d)  { return d.["PESA dept group alias"]; })
			.key(function(d)  { return d.["Economic category"]; })
			.key(function(d)  { return d.["Spending programme"]; })
			.entries(csv_data);
		...
		root = reSortRoot(root,"April 2010 MTH");
